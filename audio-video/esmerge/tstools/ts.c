        ...
        else
        {
            ...
            case 10:            // We'll assume the length is a multiple of 4
                ...
                for (ii = 0; ii < this_length/4; ii++)
                {
                    ...
                    switch (audio_type)
                    {
                    case 0: /*fprintf(stream,"/undefined");*/
                        break;  // clearer to say nowt?
                    case 1:
                        fprintf(stream,"/clean effects");
                        break;
                    case 2:
                        fprintf(stream,"/hearing impaired");
                        break;
                    case 3:
                        fprintf(stream,"/visual impaired commentary");
                        break;
                    default:
                        fprintf(stream,"/reserved:0x%02x",audio_type);
                        break;
                    }
                }
                fprintf(stream,"\n");
            ...
            case 0x56:  // teletext
                for (ii = 0; ii < this_length; ii += 5)
                {
                    ...
                    {
                    case 1:
                        fprintf(stream,"Initial");
                        break;
                    case 2:
                        fprintf(stream,"Subtitles");
                        break;
                    case 3:
                        fprintf(stream,"Additional info");
                        break;
                    case 4:
                        fprintf(stream,"Programme schedule");
                        break;
                    case 5:
                        fprintf(stream,"Hearing impaired subtitles");
                        break;
                    default:
                        fprintf(stream,"%x (reserved)",teletext_type);
                        break;
                    }
